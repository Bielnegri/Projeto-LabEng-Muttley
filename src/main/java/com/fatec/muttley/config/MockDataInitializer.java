...
public class MockDataInitializer {
    ...
    CommandLineRunner loadMockData(
        ...
        return args -> {
            ...
            Disciplina disciplina1 = disciplinaRepository.save(new Disciplina(null, "Laboratório de Engenharia de Software", "Práticas e projeto aplicado", TurnoDisciplinaEnum.MATUTINO, profSoftware, new ArrayList<>()));
            Disciplina disciplina2 = disciplinaRepository.save(new Disciplina(null, "Arquitetura de Sistemas", "Modelagem e padrões arquiteturais", TurnoDisciplinaEnum.MATUTINO, profSoftware, new ArrayList<>()));
            ...
            Disciplina disciplina4 = disciplinaRepository.save(new Disciplina(null, "Inteligência Artificial", "Fundamentos e aplicações de IA", TurnoDisciplinaEnum.MATUTINO, profDados, new ArrayList<>()));
            Disciplina disciplina5 = disciplinaRepository.save(new Disciplina(null, "Segurança da Informação", "Boas práticas, riscos e defesa", TurnoDisciplinaEnum.MATUTINO, profRedes, new ArrayList<>()));
            Disciplina disciplina6 = disciplinaRepository.save(new Disciplina(null, "Gestão de Produtos Digitais", "Descoberta, métricas e roadmap", TurnoDisciplinaEnum.MATUTINO, profProduto, new ArrayList<>()));
